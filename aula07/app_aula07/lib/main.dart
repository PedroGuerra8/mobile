...
// void main função principal  do app
void main() {
  // runApp função que constroi o app chamando a classe do tipo Stateless
  runApp(Telapp());
}
...
// override polimorfismo, permite tratar objetos de diferentes formas
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      // Remove a faixa de debug do app
      debugShowCheckedModeBanner: false,
      home: Column(
        // alinhamento primário
        ...
        child: Text("Senai - Mobile", style: TextStyle(fontSize: 30,
        color: Colors.white,
        decoration: TextDecoration.none),
        ),),
        Row(
        ...
        Stack(
          ...
          children: [
            ...
            child: Text("Pedro", textAlign: TextAlign.center,
            style: TextStyle(
              color: Colors.white,
              decoration: TextDecoration.none,
              fontSize: 25,
